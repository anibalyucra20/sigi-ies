                ...
                <div class="main_container">
                    ...
                    <div class="right_col" role="main">
                        ...
                        <div class="row tile_count">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                <?php
                                $b_matt = buscarMatriculaByPeriodoSede($conexion, $periodo, $sede);
                                $cont_mat = mysqli_num_rows($b_matt);
                                ?>
                                <span class="count_top"><i class="fa fa-child"></i> Matrículas</span>
                                <div class="count"><?php echo $cont_mat; ?></div>
                                <span class="count_bottom"><a href=""><i class="green">Ver</i></a></span>
                            </div>
                            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                <?php 
                                $cont_progs=0;
                                $b_programa_sede = buscarProgramaEstudioSedeByIdSede($conexion, $id_sede_act);
                                while ($rb_programasede = mysqli_fetch_array($b_programa_sede)) {
                                    $id_programa_sede= $rb_programasede['id'];
                                    $b_programacion_ud = buscarProgramacionUDByPeriodoSede($conexion, $id_sede_act, $id_programa_sede);
                                    while ($rb_programacion_ud = mysqli_fetch_array($b_programacion_ud)) {
                                        $cont_progs++;
                                    }
                                }
                                ?>
                                <span class="count_top"><i class="fa fa-child"></i> Unidades Didácticas Programadas</span>
                                <div class="count"><?php echo $cont_progs; ?></div>
                                <span class="count_bottom"><a href=""><i class="green">Ver</i></a></span>
                            </div>
                        </div>
                    </div>
