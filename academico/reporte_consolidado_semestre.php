                    ...
                    <div class="right_col" role="main">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <h2 align="center"><b>REPORTE CONSOLIDADO - <?php echo $rb_pe['nombre'] . " - SEMESTRE " . $rb_semestre['descripcion'] . " " . $rb_periodo_act['nombre']; ?></b></h2>
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                        <th colspan="<?php echo $cont_ind_logro_cap_ud; ?>" style="height: 100px; text-align:center;">
                                                            <p class="verticalll"><?php echo $r_b_udd['nombre'] . "<br>" . $r_bb_ud['creditos'] . " Créditos"; ?></p>
                                                        </th>
                                                    <?php
                                                    }
                                                    ?>
