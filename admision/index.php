...
include("../include/verificar_sesion_admision.php");

if (!verificar_sesion($conexion)) {
    $sistema = base64_encode('S_ADMISION');
    echo "<script>
                  window.location.replace('../passport/index?data=" . $sistema . "');
              </script>";
} else {
    // validamos si su rol corresponde
    $b_sesion = buscarSesionLoginById($conexion, $_SESSION['admision_id_sesion']);
    ...
    $b_sistema = buscarSistemaByCodigo($conexion, 'S_ADMISION');
                    ...
                    <div class="right_col" role="main">
                        ...
                        <div class="row tile_count">
                            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                ...
                                ?>
                                <div class="count"><?php echo $rb_ult_periodo['nombre']; ?></div>
