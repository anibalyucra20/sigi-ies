                                                ...
                                                <table id="example" class="table dt-responsive " width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($r_b_lecturas = mysqli_fetch_array($b_lecturas)) {
                                                            ...
                                                            $b_sesion_lectura = buscarSesionLoginById($conexion, $id_sesion);
                                                            $rb_sesion_lectura = mysqli_fetch_array($b_sesion_lectura);

                                                            $b_usuario = buscarUsuarioById($conexion, $rb_sesion_lectura['id_usuario']);
                                                            $r_b_usuario = mysqli_fetch_array($b_usuario);
                                                            $buscar_pe = buscarProgramaEstudioById($conexion, $r_b_usuario['id_programa_estudios']);
