                                    ...
                                    <div class="col-xl-12 col-md-12">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <form role="form" action="operaciones/registrar_libro" method="POST" enctype="multipart/form-data">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="editorial" placeholder="Opcional">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label>Año de Edicion :</label>
                                                            <input type="text" class="form-control" name="edicion" placeholder="Opcional">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label>Tomo :</label>
                                                            <input type="text" class="form-control" name="tomo" placeholder="Opcional">
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            <label>ISBN :</label>
                                                            <input type="text" class="form-control" name="isbn" placeholder="Opcional">
                                                        </div>
                                                        <div class="col-md-12 mb-3">
                                                    ...
                                                    <center>
                                                        <a href="libros" class="btn btn-danger" style="margin-right: 50px;">Cancelar</a>    
