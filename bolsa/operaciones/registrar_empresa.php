...
if (!verificar_sesion($conexion)) {
    ...
    <a href='../../include/cerrar_sesion_bolsa.php'>Cerrar Sesión</a><br>
        ...
        if ($rb_permiso['id_rol'] != 1) {
            ...
            $consultaa = "INSERT INTO bolsa_empresa (ruc, empresa, direccion, telefono, email, id_usuario,fecha_registro) VALUES ('$ruc', '$empresa', '$direccion','$telefono','$email','$user','$hoy')";
