...
if (!verificar_sesion($conexion)) {
    ...
    <a href='../include/cerrar_sesion_sigi.php'>Cerrar Sesión</a><br>
        ...
        $id_competencia = base64_decode($_GET['id']);
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control" id="modulo" name="modulo" value="<?php echo $res_busc_comp['id_modulo']; ?>" required="required">
                                                                    <?php
                                                                    $ejec_busc_modu = buscarModuloFormativoByIdPe($conexion, $id_p_e);
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control" id="tipo" name="tipo" required="required">
                                                                    <option value=""></option>
                                                                    <option value="ESPECÍFICA" <?php if ("ESPECÍFICA" == $res_busc_comp['tipo']) {
                                                                                                    echo "selected";
                                                                                                } ?>>ESPECÍFICA</option>
                                                                    <option value="EMPLEABILIDAD" <?php if ("EMPLEABILIDAD" == $res_busc_comp['tipo']) {
                                                                                                        echo "selected";
