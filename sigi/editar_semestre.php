...
if (!verificar_sesion($conexion)) {
    ...
    if ($rb_permiso['id_rol'] != 1 || $rb_usuario['estado'] == 0) {
        ...
        $id_semestre = base64_decode($_GET['data']);
        $b_semestre = buscarSemestreById($conexion, $id_semestre);
        $rb_semestre = mysqli_fetch_array($b_semestre);

        $id_modulo = $rb_semestre['id_modulo_formativo'];
        $b_modulo = buscarModuloFormativoById($conexion, $id_modulo);
        $rb_modulo = mysqli_fetch_array($b_modulo);
        $id_pe = $rb_modulo['id_programa_estudio'];
        # code...
?>
        <!DOCTYPE html>
        <html lang="es">
        ...
        <head>
            ...
            <title>Editar Semestre<?php include("../include/header_title.php"); ?></title>
            <!--icono en el titulo-->
                        ...
                        <div class="">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="">
                                            <h2 align="center">Editar Semestre</h2>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="x_content">
                                            <br />
                                            <form role="form" action="operaciones/actualizar_semestre.php" class="form-horizontal form-label-left input_mask" method="POST">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <select id="carrera_m" name="carrera_m" class="form-control">
                                                            ...
                                                            ?>
                                                                <option value="<?php echo $id_carr; ?>" <?php if($id_pe == $id_carr){ echo "selected"; } ?>><?php echo $carr; ?></option>
                                                            <?php
                                                            }
                                                            ?>
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <select id="modulo" name="modulo" class="form-control">
                                                            <option value=""></option>
                                                            <?php
                                                            $ejec_busc_mf = buscarModuloFormativoByIdPe($conexion, $id_pe);
                                                            while ($res_busc_mf = mysqli_fetch_array($ejec_busc_mf)) {
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-12">
                                                        <input type="text" class="form-control" name="semestre" required="required" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();" maxlength="3" value="<?php echo $rb_semestre['descripcion']; ?>">
                                                        <br>
                                                    </div>
                                                </div>
                                                <div align="center">
                                                    <a href="semestre" class="btn btn-default">Cancelar</a>
