...
if (!verificar_sesion($conexion)) {
    ...
    <a href='../include/cerrar_sesion_sigi.php'>Cerrar Sesión</a><br>
        ...
        $id_ud = base64_decode($_GET['id']);

        $ejec_busc_ud = buscarUnidadDidacticaById($conexion, $id_ud);
...
?>
        ...
        <head>
            ...
            <!-- bootstrap-wysiwyg -->
            <link href="../plantilla/Gentella/vendors/google-code-prettify/bin/prettify.min.css" rel="stylesheet">
            <!-- Select2 -->
            <link href="../plantilla/Gentella/vendors/select2/dist/css/select2.min.css" rel="stylesheet">
            <!-- Switchery -->
            <link href="../plantilla/Gentella/vendors/switchery/dist/switchery.min.css" rel="stylesheet">
            <!-- starrr -->
            <link href="../plantilla/Gentella/vendors/starrr/dist/starrr.css" rel="stylesheet">
                                            ...
                                            <div class="x_panel">
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <form role="form" action="operaciones/actualizar_unidad_didactiva.php" class="form-horizontal form-label-left input_mask" method="POST" enctype="multipart/form-data">
                                                        <input type="hidden" name="data" value="<?php echo $_GET['id']; ?>">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Unidad Didáctica : </label>
                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                <input type="text" class="form-control" name="ud" required="" value="<?php echo $res_busc_ud['nombre']; ?>" style="text-transform:uppercase;" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                                                <br>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control" id="carrera_m" name="carrera_m" required="">
                                                                    <option></option>
                                                                    <?php
                                                                    $ejec_busc_car_prof = buscarProgramaEstudio($conexion);
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control" id="modulo" name="modulo" required="required">
                                                                    <?php
                                                                    $ejec_busc_modu = buscarModuloFormativoByIdPe($conexion, $id_carrera);
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9 col-sm-9 col-xs-12">
                                                                <select class="form-control" name="semestre" id="semestre" value="<?php echo $id_semestre; ?>" required="">
                                                                    <option></option>
                                                                    <?php
                                                                    $ejec_busc_sem = buscarSemestreByIdModulo_Formativo($conexion, $id_modulo);
      ...
      <script src="../plantilla/Gentella/build/js/custom.min.js"></script>
            ...
            <script type="text/javascript">
                function recargarlista() {
                    ...
                    setTimeout(recargarsemestre, 200);
                }
            </script>
            <script type="text/javascript">
