    ...
    <body class="nav-md">
      <div class="container body">
        <div class="main_container">
          <?php include "include/menu_director.php"; ?>
          <!-- page content -->
          <div class="right_col" role="main">
            ...
            <div class="row tile_count">
              <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                ...
                <div class="count">2024-I</div>
                <span class="count_bottom"><a href=""><i class="green">.</i></a></span>
              </div>
              <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <span class="count_top"><i class="fa fa-child"></i> Sedes</span>
                <div class="count">12</div>
                <span class="count_bottom"><a href=""><i class="green">Ver</i></a></span>
              </div>
              <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <span class="count_top"><i class="fa fa-child"></i> Docentes</span>
                <div class="count">12</div>
                <span class="count_bottom"><a href=""><i class="green">Ver</i></a></span>
              </div>
              <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                <span class="count_top"><i class="fa fa-child"></i> Programas de Estudio</span>
                <div class="count">12</div>
                <span class="count_bottom"><a href=""><i class="green">Ver</i></a></span>
              </div>
            </div>
