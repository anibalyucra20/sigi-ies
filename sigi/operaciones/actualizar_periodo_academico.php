...
if (!verificar_sesion($conexion)) {
    ...
    if ($rb_permiso['id_rol'] != 1 || $rb_usuario['estado'] == 0) {
        ...
        //actualizar
        $consulta = "UPDATE sigi_periodo_academico SET nombre='$per_acad', fecha_inicio='$fecha_inicio', fecha_fin='$fecha_fin', director='$id_director' ,fecha_actas='$fecha_actas' WHERE id=$id";
