...
if (!verificar_sesion($conexion)) {
    ...
    if ($rb_permiso['id_rol'] != 1 || $rb_usuario['estado'] == 0) {
        ...
        $id_ud = base64_decode($_POST['data']);
        $ud = $_POST['ud'];
        ...
        //actualizar
        $sql = "UPDATE sigi_unidad_didactica SET nombre='$ud', id_semestre='$semestre', creditos='$creditos', horas='$horas', tipo='$tipo' WHERE id=$id_ud";
