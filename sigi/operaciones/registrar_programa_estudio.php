...
if (!verificar_sesion($conexion)) {
    ...
    if ($rb_permiso['id_rol'] != 1 || $rb_usuario['estado'] == 0) {
        ...
        $insertar = "INSERT INTO sigi_programa_estudios (codigo, tipo, plan_estudios, nombre, resolucion, perfil_egresado) VALUES ('$codigo','$tipo','$plan_estudios', '$nombre', '$resolucion', '$perfil_egresado')";
